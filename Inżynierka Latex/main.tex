...
\lstdefinelanguage{PowerFx}{
    morekeywords={Set, ClearCollect, LookUp, AddColumns, Filter, Max, Text, Now, If, And, Or,MyProfile},
    sensitive=true,
    ...
    morekeywords=[4]{Lista_Uslug, Lista_Kwot, Lista_Indykacji},  % Przykład kolekcji
