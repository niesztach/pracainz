...
\draw [ color=SkyBlue, line width=3pt] (-10,22.75) rectangle  node {}  (1.75,5.75); %true
...
\node (annotation) [rectangle,text width=6.5cm, draw=SkyBlue,line width=0.75mm, inner sep=5pt] at (-8,1.25) {\textbf{For each list, a separate branch should be presented. However, due to the similarity between them, only one branch has been depicted to enhance clarity and readability.
}};
%Arrows
...
\draw [arrow, line width=0.75mm, SkyBlue] (annotation) -- (-10,5.75);
